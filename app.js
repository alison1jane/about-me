...
alert('Hi there, ' + user + ', I have some questions for you today.');

var answer1 = prompt(user + ', this is a yes/no quesion so please answer with a Y or N. Do I like to hike?');
...
var question2 = prompt('So, ' + user + ' Do I have children? Please answer with a Y or N');
...
var question3 = prompt('Next question, Am I a Husky? (Y/N again, thanks!)');

console.log('The user answered Question 3:' + question3);

if(question3 === 'Y' || question3 === 'y') {
